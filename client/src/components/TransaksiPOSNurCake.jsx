...
const TransaksiPOSNurCake = ({
...

  {
    showCakeDetails && selectedCakeDetails && (
      <Dialog open={showDetails} onOpenChange={setShowDetails}>
        <DialogContent className="sm:max-w-[425px] bg-[#2d2d2d] border-[#FFD700] border">
          <DialogHeader>
          ...
          <div className="space-y-4 text-[#DAA520]">
            {selectedItemDetails?.id_custom ? (
  ...
  return (
    ...
    <Card className="w-full max-w-4xl mx-auto bg-[#2d2d2d] border-[#FFD700] border">
      ...
      <Dialog open={showDetails} onOpenChange={setShowDetails}>
        <DialogContent className="bg-[#2d2d2d] text-[#DAA520] border-[#FFD700]">
          <DialogHeader>
            <DialogTitle className="text-[#FFD700]">
              {selectedItemDetails?.id_custom
                ? "Detail Kue Pesanan"
